function setup() {
  ...
  function gotResult(error, results) {
    ...
    console.log(results);
    document.getElementById('label').innerHTML = 'Uniobjeto: ' + results[0].label;
  
    document.getElementById('confidence').innerHTML = 'Unipresición: ' + Math.round(results[0].confidence * 100) + '%';
